...
const rootUrl = process.env.NODE_ENV === 'production' ? 'http://192.168.1.130:7001/api/v1' : 'http://192.168.1.130:7001/api/v1'
const _socket = process.env.NODE_ENV === 'production' ? '/socket' : 'http://192.168.1.130:7001/io'
