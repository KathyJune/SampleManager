...
const rootUrl = process.env.NODE_ENV === 'production' ? 'http://192.168.1.152:9981' : 'http://192.168.1.152:9981/api/v1'
const _socket = process.env.NODE_ENV === 'production' ? '/socket' : '/socket'
