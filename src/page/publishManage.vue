<template>
<div class="publish animated fadeIn">
        ...
        <b-card>
          <template slot="header">
            <div class="batch-info">
              ...
              <label>成功：</label><span class="text-success" v-html="total - failureTotal - pushing"></span>
              <label>发布中：</label><span class="text-primary" v-html="pushing"></span>
          ...
          <el-table
            ...
            <el-table-column
              property="state"
              label="状态"
              :filters="[{ text: '成功', value: 1 }, { text: '失败', value: 0 }, { text: '发布中', value: 2 }]"
              ...
              <template slot-scope="scope">
                <el-tag
                  ...
                  disable-transitions>{{scope.row.state === 1 ? '成功': scope.row.state === 2 ? '发布中' : '失败'}}
                </el-tag>
              </template>
            </el-table-column>
            <el-table-column
