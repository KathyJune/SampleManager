<template>
<div class="upload animated fadeIn">
  <div style="margin-top:15px"></div>
  <div class="upload-panel">
    <div class="list-panel">
      <b-card>
        <template slot="header">
          <DateRangePicker v-model="dataRange" @confirm="confirm"></DateRangePicker>
        </template>
      ...
      <b-card>
        <template slot="header">
          <div class="batch-info">
            ...
            <label>成功：</label><span class="text-success" v-html="total - failureTotal"></span>
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-tag
                ...
                disable-transitions>{{scope.row.state === 1 ? '成功': '失败'}}
              </el-tag>
            </template>
          </el-table-column>
          <el-table-column
...
import DateRangePicker from 'src/components/date/daterange'
export default {
  name: 'upload',
  components: {
    DateRangePicker
